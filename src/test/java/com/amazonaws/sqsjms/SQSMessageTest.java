...
import static com.amazonaws.sqsjms.SQSJMSClientConstants.APPROXIMATE_RECEIVE_COUNT;
import static com.amazonaws.sqsjms.SQSJMSClientConstants.JMSX_DELIVERY_COUNT;
...
public class SQSMessageTest {
    ...
    public void testSQSMessageAttributeToProperty() throws JMSException {
        ...
        messageAttributes.put(myTrueBoolean, new MessageAttributeValue()
                                                    .withDataType(SQSJMSClientConstants.BOOLEAN)
                                                    .withStringValue("1"));
