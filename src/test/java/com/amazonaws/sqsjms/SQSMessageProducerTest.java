...
public class SQSMessageProducerTest {
    ...
    private AmazonSQSClientJMSWrapper amazonSQSClient;
    ...
    public void setup() throws JMSException {
        ...
        destination = new SQSDestination(QUEUE_NAME, QUEUE_URL);
    ...
    public void testSendInternalSQSTextMessageFromReceivedMessage() throws JMSException {
        ...
        mapAttributes.put(SQSJMSClientConstants.APPROXIMATE_RECEIVE_COUNT, "1");
    ...
    public void testSendInternalSQSObjectMessage() throws JMSException {
        ...
        List<String> messagesBody = Arrays.asList(SQSObjectMessage.serialize(set1), SQSObjectMessage.serialize(set2));
