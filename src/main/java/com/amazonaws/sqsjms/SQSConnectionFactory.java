...
public class SQSConnectionFactory implements ConnectionFactory, QueueConnectionFactory {
    ...
    public SQSConnection createConnection(AWSCredentials awsCredentials) throws JMSException {
        ...
        AmazonSQSClientJMSWrapper amazonSQSClientJMSWrapper = new AmazonSQSClientJMSWrapper(amazonSQSClient);
    ...
    public static class Builder {
        ...
        public Builder() {
            ...
            clientConfiguration.setUserAgent(
                    clientConfiguration.getUserAgent() + SQSJMSClientConstants.APPENDED_USER_AGENT_HEADER_VERSION );
            
            // Set default numberOfMessagesToPrefetch to MIN_BATCH.
            this.numberOfMessagesToPrefetch = SQSJMSClientConstants.MIN_BATCH;
        }
        ...
        public void setClientConfiguration(ClientConfiguration clientConfig) {
            ...
            clientConfiguration.setUserAgent(
                    clientConfig.getUserAgent() + SQSJMSClientConstants.APPENDED_USER_AGENT_HEADER_VERSION );
        }
