...
public class SQSJMSClientConstants {
    ...
    // JMSMessage Available User Property Types
    ...
    static final String JMSX_GROUP_SEC = "JMSXGroupSeq";
    ...
    static {
        try {
            APPENDED_USER_AGENT_HEADER_VERSION = String.format(
                    "/SQS JMS Client v%s", CONNECTION_METADATA.getProviderVersion());
